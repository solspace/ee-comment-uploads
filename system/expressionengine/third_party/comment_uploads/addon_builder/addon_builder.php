...
class Addon_builder_comment_uploads
{
	/**
	 * AOB version
	...
	public function data()
	{
		...
		else
		{
			...
			{
				if ( ! class_exists('Addon_builder_data_comment_uploads'))
				{
					require_once $this->aob_path . 'data.addon_builder.php';
				}

				$this->data = new Addon_builder_data_comment_uploads($this);
			}
